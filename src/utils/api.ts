...
export async function getMonitors(): Promise<MonitorInfo[]> {
  return await invokeWithDebug('get_monitors');
}

// System commands
/** 璇诲彇绯荤粺鐘舵€佷俊鎭紙鍕挎壈妯″紡銆佸叏灞忕瓑锛夈€?*/
export async function getSystemStatus(): Promise<SystemStatus> {
  return await invokeWithDebug('get_system_status');
}
...
export async function openReminderWindow(
  ...
  return await invokeWithDebug('open_reminder_window', { fullscreen, floatingPosition });
}
